...
On Error Resume Next
  ...
  If TempSpeed < 1000 Then
  CPU_Speed = Format(Val(TempSpeed), "0.00") & " MHz"
  Else
  CPU_Speed = Format(Round((Val(TempSpeed) / 1000), 4), "0.00") & " GHz"
  End If
...
Function FormatFileSize(ByVal TheSize_BYTEs As Long) As String
On Error Resume Next
  ...
  Else
    Select Case TheSize_BYTEs \ KB
      ...
      Case Is < 100000000
        FormatSoFar = Format(TheSize_BYTEs / MB / KB, "0.00") & " TB"
    End Select
